    ...
    <div className="page">
      ...
      <section className="content-section">
        ...
        <div className="subsection">
          ...
          <p>
            Community events and activities on climate action and sustainability happen throughout Wisconsin during the year. In April of every year, Earth Day is celebrated around Wisconsin, including through educational presentations, tree plantings, and community gatherings organized by universities, municipalities, and organizations with environmental interests. The University of Wisconsin-Madison hosts Earth Fest activities with demonstrations and workshops focused on sustainability. The Wisconsin Environmental Initiative participates in events celebrating clean energy infrastructure, supported through the Inflation Reduction Act, and the positive impact of this legislation on sustainable development. More than 70 partners joined forces in 2024 to create a new group called the Clean Economy Coalition of Wisconsin, officially launching on Earth Day to foster collaborative climate action in businesses, organizations, and communities. The Wisconsin Initiative on Climate Change Impacts gathers together scientists and stakeholders throughout the state to develop a comprehensive review of climate change impacts and facilitate solutions through public outreach and education.
          </p>
          <p>
            Beyond Earth Day, there are climate and sustainability events throughout the year in which Wisconsinites can engage. From natural climate solutions and conservation to environmental education strategies, various educational presentations around the state take place regularly by Wisconsin's Green Fire. In Madison, the annual Renew Wisconsin Summit unites upwards of 750 attendees, including experts, policy-makers, and community leaders, to share on the current status and future potential of clean energy, emerging technologies, and workforce development. The public rallies with climate marches across the state, including the Wisconsin Climate March in Madison, in support of solar power, clean jobs, environmental justice, and conservation. Community planting campaigns began as a result of Governor Tony Evers' pledge to plant a trillion trees, and through this, efforts have begun to reach goals of 100 million trees across the state by 2030, including one million in urban areas. Events provide opportunities for people to learn about reducing fossil fuels, connect with others on important issues, and take group action toward a more sustainable future for Wisconsin.
          </p>
        </div>
      </section>
    </div>
